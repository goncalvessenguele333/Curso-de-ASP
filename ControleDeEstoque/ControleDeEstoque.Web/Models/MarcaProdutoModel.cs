            ...
            using (var conn = new SqlConnection())
            {
                ...
                using (var cmd = new SqlCommand())
                {
                    ...
                    cmd.CommandText = string.Format(
                        "Select * from tb_marca_produto order by nome offset {0} rows fetch next {1} rows only",
        ...
        public static int RecuperarQuantidade()
        {
            ...
            using (var conn = new SqlConnection())
            {
                ...
                using (var cmd = new SqlCommand())
                {
                    ...
                    cmd.CommandText = "Select count(*) from tb_marca_produto";
        ...
        public static MarcaProdutoModel RecuperarPeloId(int id)
        {
            ...
            using (var conn = new SqlConnection())
            {
                ...
                using (var cmd = new SqlCommand())
                {
                    ...
                    cmd.CommandText = "Select * from tb_marca_produto where id=@id";
        ...
        public static bool ExcluirPeloId(int id)
        {
            ...
            if (RecuperarPeloId(id) != null)
            {
                using (var conn = new SqlConnection())
                {
                    ...
                    {
                        cmd.Connection = conn;
                        cmd.CommandText = "delete from tb_marca_produto where id=@id";
                        cmd.Parameters.Add("@id", SqlDbType.Int).Value = id;
            ...
            using (var conn = new SqlConnection())
            {
                ...
                using (var cmd = new SqlCommand())
                {
                    ...
                    if (model == null)
                    {
                        ...
                        cmd.CommandText = "insert into tb_marca_produto (nome, activo)values (@nome,@activo); select convert(int, SCOPE_IDENTITY())";
                    ...
                    {
                        cmd.CommandText = "update tb_marca_produto set nome=@nome, activo=@activo where id=@id";
                        cmd.Parameters.Add("@nome", SqlDbType.VarChar).Value = this.nome;
                        cmd.Parameters.Add("@activo", SqlDbType.VarChar).Value = (this.activo ? 1 : 0);
